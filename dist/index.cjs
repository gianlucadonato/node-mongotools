...
__export(lib_exports, {
  MTCommand: () => MTCommand_default,
  MTOptions: () => MTOptions,
  MongoTools: () => MongoTools_default
});
...
// lib/MTWrapper.js
var ssync = import_child_process.default.spawnSync;
var MTWrapper = class {
      ...
      try {
        ...
        if (restore.status === 0) {
          if ("deleteDumpAfterRestore" in options && options.deleteDumpAfterRestore === true) {
            import_fs.default.unlinkSync(dumpFile);
          }
          resolve({
...
function getNowFormatted() {
  return (0, import_date_fns.format)(/* @__PURE__ */ new Date(), "yyyy-MM-dd_HHMMss");
}
